...
<a class="${active==="detailed"?"active":""}" href="original-tables.html">Detailed Tables</a></nav></div></header>`}
...
function home(){page("home",`<section class="hero"><div><div class="eyebrow">GROUP TRIP</div><h1>Mata Vaishno Devi Mandir, Katra</h1><p>Family-wise trip information and shared expense tracking.</p><div class="actions"><a class="btn gold" href="family-expenses.html">Check Pre Trip Expenses</a><a class="btn" href="trip-expenses.html">View Trip Expenses</a></div></div></section><section class="grid"><a class="card" href="family-expenses.html"><h3>Pre Trip Expenses</h3><p>Select a family and see its ticket, hotel and total expense.</p></a><a class="card" href="trip-expenses.html"><h3>Trip Expenses</h3><p>Shared expenses are stored in the online database.</p></a><a class="card" href="admin.html"><h3>Admin</h3><p>Sign in to add or delete shared expenses.</p></a></section>${setupBanner()}<section class="card notice"><b>Source figures:</b> Family expense values from the supplied PDF are displayed as source figures and are not recalculated.</section>` ,"Home")}
function family(){
...
if(path==="index.html")home();else if(path==="family-expenses.html")family();else if(path==="trip-expenses.html")trip();else if(path==="admin.html")admin();else if(path==="original-tables.html")detailedTables();else home();
