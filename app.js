...
function gallery(){page("gallery",`<section class="page-hero"><div class="eyebrow">JAMMU · KATRA · PILGRIMAGE ROUTE</div><h1>Places to Visit</h1><p>Important temples, caves, pilgrimage spots and scenic places commonly included around the Katra–Jammu journey.</p></section><section class="gallery-grid">
<figure class="gallery-item tall"><img src="assets/places/shiv-khori.jpg" alt="Shiv Khori"><figcaption><b>Shiv Khori</b><span>Holy cave shrine</span></figcaption></figure>
<figure class="gallery-item"><img src="assets/places/baba-dhansar.jpg" alt="Baba Dhansar"><figcaption><b>Baba Dhansar</b><span>Waterfall & shrine</span></figcaption></figure>
<figure class="gallery-item"><img src="assets/places/nau-devi.jpg" alt="Nau Devi Temple"><figcaption><b>Nau Devi Temple</b><span>Near Katra</span></figcaption></figure>
<figure class="gallery-item"><img src="assets/places/krimchi-temple.jpg" alt="Krimchi Temple complex"><figcaption><b>Krimchi Temple Complex</b><span>Ancient temples</span></figcaption></figure>
<figure class="gallery-item"><img src="assets/places/kol-kandoli-temple.jpg" alt="Kol Kandoli Temple"><figcaption><b>Kol Kandoli Temple</b><span>Jammu region</span></figcaption></figure>
<figure class="gallery-item"><img src="assets/places/bawe-wali-mata.jpg" alt="Bawe Wali Mata Temple"><figcaption><b>Bawe Wali Mata Temple</b><span>Bahu, Jammu</span></figcaption></figure>
<figure class="gallery-item wide"><img src="assets/places/raghunath-temple.jpg" alt="Raghunath Temple"><figcaption><b>Raghunath Temple</b><span>Jammu</span></figcaption></figure>
<figure class="gallery-item"><img src="assets/places/ranbireshwar-temple.jpg" alt="Ranbireshwar Temple"><figcaption><b>Ranbireshwar Temple</b><span>Jammu</span></figcaption></figure>
<figure class="gallery-item"><img src="assets/places/peer-kho.jpg" alt="Peer Kho Cave Temple"><figcaption><b>Peer Kho Cave Temple</b><span>Jammu</span></figcaption></figure>
<figure class="gallery-item"><img src="assets/places/patnitop-sudhmahadev.jpg" alt="Patnitop and Sudhmahadev"><figcaption><b>Patnitop / Sudhmahadev</b><span>Mountain route</span></figcaption></figure>
<figure class="gallery-item tall"><img src="assets/places/vaishno-devi-bhawan.jpg" alt="Vaishno Devi Bhawan"><figcaption><b>Vaishno Devi Bhawan</b><span>Trikuta Hills</span></figcaption></figure>
<figure class="gallery-item wide"><img src="assets/places/katra-trikuta-hills.jpg" alt="Katra and Trikuta Hills"><figcaption><b>Katra / Trikuta Hills</b><span>Scenery around Katra</span></figcaption></figure>
</section><section class="card source-note"><b>Images:</b> These gallery photographs were supplied for this trip website and cropped from the images provided in this chat.</section>`,"Gallery · Vaishno Devi Group Trip")}
function food(){const foods=[
{name:"Rajma Chawal",tag:"Jammu classic",desc:"Rajma served with rice — one of the best-known traditional dishes associated with Jammu.",img:"assets/food/rajma-chawal.jpg"},
{name:"Kaladi / Kalari Kulcha",tag:"Local favourite",desc:"A popular Jammu-region preparation featuring local Kaladi/Kalari cheese with kulcha.",img:"assets/food/kaladi-kalari-kulcha.jpg"},
{name:"Ambal",tag:"Dogri cuisine",desc:"A traditional Dogri sweet-and-tangy preparation found in Jammu's regional cuisine.",img:"assets/food/ambal.jpg"},
{name:"Kulthein di Dal",tag:"Traditional",desc:"A traditional Dogri lentil preparation associated with the Jammu region.",img:"assets/food/kulthein-di-dal.jpg"},
{name:"Kashmiri Aloo Dum",tag:"Classic",desc:"Spiced potato preparation widely associated with Jammu and Kashmir cuisine.",img:"assets/food/kashmiri-aloo-dum.jpg"},
{name:"Patisa",tag:"Sweet",desc:"A flaky, rich traditional sweet and a well-known Jammu speciality.",img:"assets/food/patisa.jpg"},
{name:"Sund Panjeeri",tag:"Sweet",desc:"A traditional dry-fruit-rich sweet associated with Jammu's food culture.",img:"assets/food/sund-panjeeri.jpg"},
{name:"Chocolate Barfi",tag:"Sweet",desc:"A popular local-style sweet variation made with barfi and chocolate flavour.",img:"assets/food/chocolate-barfi.jpg"}
];page("food",`<section class="page-hero food-hero"><div class="eyebrow">EAT LIKE A LOCAL · VEGETARIAN</div><h1>Local Delicacies</h1><p>Vegetarian dishes and sweets to look out for during the Jammu and Katra trip.</p></section><section class="food-grid">${foods.map(x=>`<article class="food-card"><div class="food-photo"><img src="${x.img}" alt="${x.name}" loading="lazy"></div><div class="food-body"><span>${x.tag}</span><h3>${x.name}</h3><p>${x.desc}</p></div></article>`).join("")}</section><section class="card modern-card"><h2>Food note for Katra</h2><p>This page intentionally lists vegetarian delicacies only.</p><div class="food-links"><a href="https://www.incredibleindia.gov.in/en/jammu-and-kashmir/jammu" target="_blank" rel="noopener">Incredible India · Jammu cuisine ↗</a><a href="https://www.jktdc.co.in/info.aspx?id=137" target="_blank" rel="noopener">JKTDC · Cuisine of Jammu ↗</a></div></section>`,"Local Delicacies · Jammu & Katra")}
